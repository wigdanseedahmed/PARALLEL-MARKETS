...
class ParallelMarketsScreen extends StatefulWidget {
  const ParallelMarketsScreen({Key? key}) : super(key: key);

  @override
  State<ParallelMarketsScreen> createState() => _ParallelMarketScreenState();
}

class _ParallelMarketScreenState extends State<ParallelMarketsScreen>
  ...
  Future<List<ClusterModel>> readClustersFromJsonFile() async {
    ...
    var uri = Uri.parse(AppUrl.getParallelMarkets);
    ...
    if (response.statusCode == 200) {
      setState(() {
        readJsonFileContent = parallelMarketsListClusterModelFromJson(
