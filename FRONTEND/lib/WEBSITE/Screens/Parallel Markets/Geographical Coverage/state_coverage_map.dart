...
class StateCoverageMap extends StatefulWidget {
  const StateCoverageMap({Key? key, required this.screenSize, this.colour})
      : super(key: key);
  ...
  @override
  _StateCoverageMapState createState() => _StateCoverageMapState();
}

class _StateCoverageMapState extends State<StateCoverageMap> {
          ...
          layers: <MapShapeLayer>[
            MapShapeLayer(
              source: const MapShapeSource.asset(
                'jsonDataFiles/sudan_state_2021.json',
