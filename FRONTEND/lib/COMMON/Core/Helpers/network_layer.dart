...
Future<List<ClusterModel>> fetchProjects(
    List<ClusterModel> readJsonFileContent) async {
  final response = await http.get(
    Uri.parse(AppUrl.getParallelMarkets),
    headers: {
  ...
  if (response.statusCode == 200) {
    readJsonFileContent = parallelMarketsListClusterModelFromJson(response.body);
