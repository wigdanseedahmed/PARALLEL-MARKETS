              ...
              children: <Widget>[
                CircleAvatar(
                  ...
                  backgroundImage: NetworkImage(
                      healthFacilityInfo.imagePath == null
                          ? healthCareDefaultImage
                          : healthFacilityInfo.imagePath!),
                  radius: 36.0,
                ),
                const SizedBox(
                  width: 10.0,
                ...
                Column(
                  ...
                  children: <Widget>[
                    RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                            text: healthFacilityInfo.medical_facility_name_en,
                            style: const TextStyle(
                              color: Colors.black,
                              fontSize: 16,
                  ...
                  /* Align(
                      ...
                      child: Padding(
                        ...
                        child: StarRating(
                          rating: healthFacilityInfo.rank == null
                              ? 0.0
                              : healthFacilityInfo.rank!,
