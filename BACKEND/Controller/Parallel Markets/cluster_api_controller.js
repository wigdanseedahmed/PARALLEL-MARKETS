const {
  clustersModel,
  ClusterSigma
} = require('../../Models/Parallel Markets/cluster_model');
...
const getClusters = ((req, res, next) => {
  ...
  async function countDocumentsBasedonClusters() {
    try {
      ...
      const countParallelMarketsClusters = await clustersModel.countDocuments({
        cluster: {
          $eq: "ParallelMarkets"
        }
      });
      ...
      ParallelMarkets: ${countParallelMarketsClusters}
